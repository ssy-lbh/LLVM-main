...
#include "llvm/IR/IntrinsicsZYNQ16.h"
...
static Value *EmitTargetArchBuiltinExpr(CodeGenFunction *CGF,
  ...
  case llvm::Triple::zynq16:
    return CGF->EmitZYNQ16BuiltinExpr(BuiltinID, E);
  default:
    return nullptr;
  }
}
...
Value *CodeGenFunction::EmitZYNQ16BuiltinExpr(unsigned BuiltinID, const CallExpr *E){
  switch (BuiltinID){
    case ZYNQ16::BI__builtin_zynq16_max_qb:{
      llvm::Function *F = CGM.getIntrinsic(Intrinsic::zynq16_max_qb);
      return Builder.CreateCall(F);
    }

    case ZYNQ16::BI__builtin_zynq16_min_qb:{
      llvm::Function *F = CGM.getIntrinsic(Intrinsic::zynq16_min_qb);
      return Builder.CreateCall(F);
    }
    default: return nullptr;
  }
